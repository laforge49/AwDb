...
/**
 * A Disk Space Management exception.
 */
public class DSMException extends BlockIOException {
    /**
     ...
     * @since 1.7
     */
    public DSMException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
